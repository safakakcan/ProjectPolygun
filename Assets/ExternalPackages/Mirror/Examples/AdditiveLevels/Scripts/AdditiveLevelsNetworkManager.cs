...
namespace Mirror.Examples.AdditiveLevels
{
    ...
    {
        [Header("Additive Scenes - First is start scene")] [Scene] [Tooltip("Add additive scenes here.\nFirst entry will be players' start scene")]
        ...
        public new static AdditiveLevelsNetworkManager singleton => (AdditiveLevelsNetworkManager)NetworkManager.singleton;
