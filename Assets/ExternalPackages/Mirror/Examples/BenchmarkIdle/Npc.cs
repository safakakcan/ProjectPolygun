...
namespace Mirror.Examples.BenchmarkIdle
{
    public class Npc : NetworkBehaviour
    {
        ...
        [Tooltip("Probability that this object just sleeps the whole time without ever getting dirty. (Npcs, Item drops, etc.)")] [Range(0, 1)]
        public float sleepingProbability = 0.80f; // 80% of the objects are sleeping

        [Header("Colors")] public Color activeColor = Color.white;
