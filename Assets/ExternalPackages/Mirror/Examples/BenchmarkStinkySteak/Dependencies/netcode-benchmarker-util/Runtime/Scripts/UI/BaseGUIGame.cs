...
namespace StinkySteak.NetcodeBenchmark
{
    public class BaseGUIGame : MonoBehaviour
    {
        ...
        [Header("Stress Test 1: Move Y")] [SerializeField]
        protected StressTestEssential _test_1;

        [Header("Stress Test 2: Move All Axis")] [SerializeField]
        protected StressTestEssential _test_2;

        [Header("Stress Test 3: Move Wander")] [SerializeField]
        ...
        protected virtual void OnGUI()
        {
            ...
            if (GUILayout.Button("Stress Test 1")) StressTest_1();
            if (GUILayout.Button("Stress Test 2")) StressTest_2();
            if (GUILayout.Button("Stress Test 3")) StressTest_3();
