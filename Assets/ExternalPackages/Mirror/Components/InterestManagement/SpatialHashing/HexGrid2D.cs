...
namespace Mirror
{
    internal class HexGrid2D
    {
        ...
        private static readonly Cell2D[] neighborCellsBase =
        {
            new(0, 0), // Center
            new(1, -1), // Top-right
            new(1, 0), // Right
        ...
        internal Cell2D WorldToCell(Vector2 position)
        {
            ...
            var q = (sqrt3Div3 * position.x - oneDiv3 * position.y) / cellRadius;
            var r = twoDiv3 * position.y / cellRadius;
    ...
    internal struct Cell2D
    {
        ...
        {
            return obj is Cell2D other && q == other.q && r == other.r;
        }
