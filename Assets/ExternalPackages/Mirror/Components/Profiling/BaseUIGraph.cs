...
namespace Mirror
{
    ...
    public abstract class BaseUIGraph : MonoBehaviour
    {
        ...
        [Range(1, 64)] public int Points = 64;

        public float SecondsPerPoint = 1;
        public Color[] CategoryColors = { Color.cyan };
        ...
        public void LateUpdate()
        {
            if (isGraphDataDirty)
            {
                ...
                if (IsStacked)
                    ...
                    {
                        float total = 0;
                        for (var c = 0; c < CategoryColors.Length; c++)
                ...
                {
                    var legendText = LegendTexts[i];
                    var pct = (float)i / (LegendTexts.Length - 1);
