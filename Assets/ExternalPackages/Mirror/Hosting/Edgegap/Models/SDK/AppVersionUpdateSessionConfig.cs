...
namespace IO.Swagger.Model
{
    ...
    public class AppVersionUpdateSessionConfig
    {
        ...
        ///     The kind of session must be: Default, Seat, Match
        /// </summary>
        /// <value>
        ///     The kind of session to create. If 'Default' if chosen, the application will be handled like a normal
        ///     application. The kind of session must be: Default, Seat, Match
        /// </value>
        ...
        /// </summary>
        /// <value>
        ///     The number of minutes a deployment of this app version can spend with no session connected before being
        ///     terminated.
        /// </value>
        ...
        /// <summary>
        ///     The number of minutes after a session-type deployment has been terminated to remove all the session information
        ///     connected to your deployment. Minimum and default value is set to 60 minutes so you can manage your session
        ///     termination before it is removed.
        /// </summary>
        /// <value>
        ///     The number of minutes after a session-type deployment has been terminated to remove all the session information
        ///     connected to your deployment. Minimum and default value is set to 60 minutes so you can manage your session
