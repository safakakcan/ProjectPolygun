...
namespace Edgegap.Editor.Api.Models.Results
{
    ...
    public class EdgegapHttpResult
    {
        ...
        public EdgegapErrorResult Error => JsonConvert.DeserializeObject<EdgegapErrorResult>(Json);
    ...
    public class EdgegapHttpResult<TResult> : EdgegapHttpResult
    {
            ...
            : base(httpResponse)
        {
            ...
            if (isLogLevelDebug)
                Debug.Log($"{typeof(TResult).Name} result: {JObject.Parse(Json)}"); // Prettified
        }
