...
namespace Edgegap.Editor.Api.Models.Requests
{
    ...
    public class UpdateAppVersionRequest
    {
        ...
        [JsonProperty("max_duration")] public int MaxDuration { get; set; } = 60;
        ...
        [JsonProperty("time_to_deploy")] public int TimeToDeploy { get; set; } = 120;
        ...
        [JsonProperty("probe")] public ProbeData Probe { get; set; } = new(); // MIRROR CHANGE: 'new()' not supported in Unity 2020
