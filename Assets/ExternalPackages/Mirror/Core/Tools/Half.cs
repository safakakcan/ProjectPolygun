...
namespace System
{
            ...
            IEquatable<Half>
    {
        ...
        public static Half Epsilon => new(EpsilonBits); //  5.9604645E-08

        public static Half PositiveInfinity => new(PositiveInfinityBits); //  1.0 / 0.0;

        public static Half NegativeInfinity => new(NegativeInfinityBits); // -1.0 / 0.0

        public static Half NaN => new(NegativeQNaNBits); //  0.0 / 0.0

        public static Half MinValue => new(MinValueBits); // -65504

        public static Half MaxValue => new(MaxValueBits); //  65504
        ...
        {
            _value = (ushort)(((sign ? 1 : 0) << SignShift) + (exp << BiasedExponentShift) + sig);
        }
        ...
        internal sbyte Exponent => (sbyte)(BiasedExponent - ExponentBias);

        internal ushort Significand => (ushort)(TrailingSignificand | (BiasedExponent != 0 ? 1U << BiasedExponentShift : 0U));
        ...
        /// </summary>
        /// <returns>
        ///     A value less than zero if this is less than <paramref name="obj" />, zero if this is equal to
        ///     <paramref name="obj" />, or a value greater than zero if this is greater than <paramref name="obj" />.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        ///     A value less than zero if this is less than <paramref name="other" />, zero if this is equal to
        ///     <paramref name="other" />, or a value greater than zero if this is greater than <paramref name="other" />.
        /// </returns>
        ...
        /// <summary>
        ///     Explicitly converts a <see cref="char" /> value to its nearest representable half-precision floating-point
        ///     value.
        /// </summary>
        ...
        /// <summary>
        ///     Explicitly converts a <see cref="decimal" /> value to its nearest representable half-precision floating-point
        ///     value.
        /// </summary>
        ...
        /// <summary>
        ///     Explicitly converts a <see cref="short" /> value to its nearest representable half-precision floating-point
        ///     value.
        /// </summary>
        ...
        /// <summary>
        ///     Explicitly converts a <see cref="int" /> value to its nearest representable half-precision floating-point
        ///     value.
        /// </summary>
        /// <returns><paramref name="value" /> converted to its nearest representable half-precision floating-point value.</returns>
        ...
        /// <summary>
        ///     Explicitly converts a <see cref="long" /> value to its nearest representable half-precision floating-point
        ///     value.
        /// </summary>
        /// <returns><paramref name="value" /> converted to its nearest representable half-precision floating-point value.</returns>
        ...
        /// <summary>
        ///     Explicitly converts a <see cref="float" /> value to its nearest representable half-precision floating-point
        ///     value.
        /// </summary>
        /// <returns><paramref name="value" /> converted to its nearest representable half-precision floating-point value.</returns>
        ...
        /// <summary>
        ///     Explicitly converts a <see cref="ushort" /> value to its nearest representable half-precision floating-point
        ///     value.
        /// </summary>
        /// <returns><paramref name="value" /> converted to its nearest representable half-precision floating-point value.</returns>
        ...
        /// <summary>
        ///     Explicitly converts a <see cref="uint" /> value to its nearest representable half-precision floating-point
        ///     value.
        /// </summary>
        /// <returns><paramref name="value" /> converted to its nearest representable half-precision floating-point value.</returns>
        ...
        /// <summary>
        ///     Explicitly converts a <see cref="ulong" /> value to its nearest representable half-precision floating-point
        ///     value.
        /// </summary>
        /// <returns><paramref name="value" /> converted to its nearest representable half-precision floating-point value.</returns>
        ...
        /// <summary>
        ///     Explicitly converts a half-precision floating-point value to its nearest representable <see cref="byte" />
        ///     value.
        /// </summary>
        ...
        /// <summary>
        ///     Explicitly converts a half-precision floating-point value to its nearest representable <see cref="char" />
        ///     value.
        /// </summary>
        ...
        /// <summary>
        ///     Explicitly converts a half-precision floating-point value to its nearest representable <see cref="decimal" />
        ///     value.
        /// </summary>
        ...
        /// <summary>
        ///     Explicitly converts a half-precision floating-point value to its nearest representable <see cref="short" />
        ///     value.
        /// </summary>
        ...
        /// <summary>
        ///     Explicitly converts a half-precision floating-point value to its nearest representable <see cref="int" />
        ///     value.
        /// </summary>
        ...
        /// <summary>
        ///     Explicitly converts a half-precision floating-point value to its nearest representable <see cref="long" />
        ///     value.
        /// </summary>
        ...
        /// <summary>
        ///     Explicitly converts a half-precision floating-point value to its nearest representable <see cref="sbyte" />
        ///     value.
        /// </summary>
        ...
        /// <summary>
        ///     Explicitly converts a half-precision floating-point value to its nearest representable <see cref="ushort" />
        ///     value.
        /// </summary>
        ...
        /// <summary>
        ///     Explicitly converts a half-precision floating-point value to its nearest representable <see cref="uint" />
        ///     value.
        /// </summary>
        ...
        /// <summary>
        ///     Explicitly converts a half-precision floating-point value to its nearest representable <see cref="ulong" />
        ///     value.
        /// </summary>
        ...
        /// <summary>
        ///     Implicitly converts a <see cref="byte" /> value to its nearest representable half-precision floating-point
        ///     value.
        /// </summary>
        /// <returns><paramref name="value" /> converted to its nearest representable half-precision floating-point value.</returns>
        ...
        /// <summary>
        ///     Implicitly converts a <see cref="sbyte" /> value to its nearest representable half-precision floating-point
        ///     value.
        /// </summary>
        /// <returns><paramref name="value" /> converted to its nearest representable half-precision floating-point value.</returns>
        ...
        /// <summary>
        ///     Explicitly converts a half-precision floating-point value to its nearest representable <see cref="float" />
        ///     value.
        /// </summary>
        ...
        public static Half E => new(EBits);

        public static Half Pi => new(PiBits);

        public static Half Tau => new(TauBits);

        //
        // IFloatingPointIeee754
        //

        public static Half NegativeZero => new(NegativeZeroBits);

        public static Half Atan2(Half y, Half x)
        {
            return (Half)Math.Atan2((float)y, (float)x);
        }
        ...
        {
            return (Half)Math.Cosh((float)x);
        }

        public static Half Sinh(Half x)
        {
            return (Half)Math.Sinh((float)x);
        }

        public static Half Tanh(Half x)
        {
            return (Half)Math.Tanh((float)x);
        }
        ...
        {
            return (Half)Math.Log((float)x);
        }

        public static Half Log(Half x, Half newBase)
        {
            return (Half)Math.Log((float)x, (float)newBase);
        }
        ...
        public static Half MultiplicativeIdentity => new(PositiveOneBits);
        ...
        {
            if (IsNaN(value)) throw new ArithmeticException("SR.Arithmetic_NaN");
        ...
        public static Half One => new(PositiveOneBits);

        public static Half Zero => new(PositiveZeroBits);

        public static Half Abs(Half value)
        {
            return new Half((ushort)(value._value & ~SignMask));
        }
...
#pragma warning restore CS1718
        ...
        {
            return (Half)Math.Pow((float)x, (float)y);
        }
        ...
        public static Half NegativeOne => new(NegativeOneBits);
        ...
        {
            return (Half)Math.Acos((float)x);
        }

        public static Half Asin(Half x)
        {
            return (Half)Math.Asin((float)x);
        }

        public static Half Atan(Half x)
        {
            return (Half)Math.Atan((float)x);
        }

        public static Half Cos(Half x)
        {
            return (Half)Math.Cos((float)x);
        }

        public static Half Sin(Half x)
        {
            return (Half)Math.Sin((float)x);
        }

        public static Half Tan(Half x)
        {
            return (Half)Math.Tan((float)x);
        }
