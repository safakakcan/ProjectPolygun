...
namespace Mirror
{
    public struct Vector4Long
    {
        ...
        public static readonly Vector4Long zero = new(0, 0, 0, 0);
        public static readonly Vector4Long one = new(1, 1, 1, 1);
        ...
        {
            return other is Vector4Long vector4 && Equals(vector4);
        }
