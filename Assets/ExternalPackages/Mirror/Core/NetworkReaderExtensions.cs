...
namespace Mirror
{
    ...
    public static class NetworkReaderExtensions
    {
        ...
        public static byte[] ReadBytesAndSize(this NetworkReader reader)
        {
            ...
            var count = (uint)Compression.DecompressVarUInt(reader);
        ...
        {
            return reader.ReadBool() ? ReadLayerMask(reader) : default(LayerMask?);
        }
        ...
        public static List<T> ReadList<T>(this NetworkReader reader)
        {
            ...
            // most sizes are small, read size as VarUInt!
            var length = (uint)Compression.DecompressVarUInt(reader);
