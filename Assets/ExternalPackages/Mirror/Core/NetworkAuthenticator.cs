...
namespace Mirror
{
    ...
    public abstract class NetworkAuthenticator : MonoBehaviour
    {
        ...
        [Header("Event Listeners (optional)")] [Tooltip("Mirror has an internal subscriber to this event. You can add your own here.")]
        ...
        private void Reset()
        {
            ...
            if (manager != null && manager.authenticator == null)
            {
                ...
                Undo.RecordObject(manager, "Assigned NetworkManager authenticator");
